...
let handler = async (_0x3585f0, {
  ...
  if (!_0x2f2134) {
    return _0x1a6b0c.reply(_0x3585f0.chat, "🚩 Ingresa El Texto De Lo Que Quieres Buscar En Tiktok", _0x3585f0, fake);
  }
 ...
 // await _0x3585f0.react(rwait);
   ...
   title: '🍭 Baileys Bot - MD',
   body: '💫 Tiktok - Search',
   previewType: 0, thumbnail: img2,
   sourceUrl: 'https://github.com/Jxtxn17/BaileyBot-MD' }}});
    let _0x26b601 = [];
    let {
      data: _0xda4544
