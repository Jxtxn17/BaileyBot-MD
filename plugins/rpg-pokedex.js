...
let handler = async (m, { conn, text }) => {
    if (!text) throw '🚫 𝐄𝐑𝐑𝐎𝐑 🚫 Por favor, proporciona el nombre de un Pokémon para buscar.';
    ...
    if (!response.ok) {
        throw `🚫 𝐄𝐑𝐑𝐎𝐑 🚫 Parece que hubo un error al buscar el Pokémon. Por favor, inténtalo de nuevo más tarde.`;
    }
