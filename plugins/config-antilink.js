...
const grupo = `https://whatsapp.com/channel|https://chat.whatsapp.com`
...
if (isBotAdmin) {
const linkThisGroup = `https://whatsapp.com/channel|https://chat.whatsapp.com/${await this.groupInviteCode(m.chat)}`
